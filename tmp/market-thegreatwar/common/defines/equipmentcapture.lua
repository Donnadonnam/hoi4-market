...
NDefines.NMilitary.ATTRITION_WHILE_MOVING_FACTOR = 0.6;

NDefines.NMilitary.OUT_OF_SUPPLY_ATTRITION = 0.45;               	-- max attrition when out of supply
...
-- Navy
NDefines.NNavy.ATTRITION_WHILE_MOVING_FACTOR = 0.75;							-- attrition multiplier while moving & doing missions
NDefines.NNavy.ATTRITION_DAMAGE_ORG = 0.025;			   				-- damage from attrition to Organisation (relative to max org)
NDefines.NNavy.ATTRITION_DAMAGE_STR = 0.04;				   				-- damage from attrition to str (relative to max str)
