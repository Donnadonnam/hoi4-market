...
$surplusAir = array();
$surplusAir[] = generateSurplusTradeDecisionData($tech, "ww1_fighter1", 100, "generic_air");
$surplusAir[] = generateSurplusTradeDecisionData($tech, "ww1_seaplane1", 100, "generic_air");
$surplusAir[] = generateSurplusTradeDecisionData($tech, "ww1_bomber1", 75, "generic_air");
$surplusAir[] = generateSurplusTradeDecisionData($tech, "ww1_zeppelin1", 50, "generic_air");
...
$surplusArmor[] = generateSurplusTradeDecisionData($tech, "ww1_light_tank", 100, "generic_tank");
$surplusArmor[] = generateSurplusTradeDecisionData($tech, "ww1_heavy_tank", 50, "generic_tank");
...
$surplusArtillery[] = generateSurplusTradeDecisionData($tech, "light_field_gun1", 125, "generic_ignite_civil_war");
$surplusArtillery[] = generateSurplusTradeDecisionData($tech, "heavy_field_gun1", 25, "generic_ignite_civil_war");
$surplusArtillery[] = generateSurplusTradeDecisionData($tech, "antitank_1915", 125, "generic_ignite_civil_war");
$surplusArtillery[] = generateSurplusTradeDecisionData($tech, "antiair_1915", 125, "generic_ignite_civil_war");
